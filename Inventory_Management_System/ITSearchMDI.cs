...
{
    public partial class ITSearchMDI : Form
    {
        ...
        private void ITSearchMDI_Load(object sender, EventArgs e)
        {
            IsMdiContainer = true;
        ...
        private void previousUserDataToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ITPreviousUserSearch frm2 = new ITPreviousUserSearch();
            frm2.MdiParent = this;
            frm2.Show();
        }
